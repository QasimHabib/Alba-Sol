    ...
    render() {
        ...
        const login = () => {
            ...
            Axios.put("https://frozen-temple-16675.herokuapp.com/reset-password", {
                ...
                this.props.history.push("/email-reset");
                //<Redirect to='/email-reset'  />
            });
        };
            ...
            <Auxiliary>
                ...
                {/* <SideBar ref={(sidebar => this.sidebar = sidebar)} >
                    ...
                    <div className="form-container form-container-mob" style={{width: 22 + "%"}}>
                        ...
                        <p className="my-5">Entrez votre e-mail pour recevoir le lien de réinitialisation du mot de passe.</p>
                        <Form>
