...
class EmailAfterReset extends Component {
            ...
            <Auxiliary>
                ...
                {/* <SideBar ref={(sidebar => this.sidebar = sidebar)} >
                    ...
                    <div className="form-container form-container-mob" style={{width: 22 + "%"}}>
                        <h1 style={{textAlign: 'center'}}>Bon Travail</h1>
                        <p className="my-5">Vérifiez votre boîte de réception pour vérifier votre e-mail.</p>
                        <img style={{margin: 'auto', display: 'block'}} src={email} alt=""/>
                    </div>
                </div>
...
export default EmailAfterReset;